      ...
      <!--*************************-->
        <!-- Example DataTables Card-->
          ...
          <div class="card-header ">Nueva cuenta</div>
            <div class="card-body">
                  <!--Formulario-->
              <form action="assets/nuevaCuenta.php" method="post">
                  <!--Campo Usuario oculto propietario de la cuenta-->
                  <input name='usuario' type="hidden" value="<?php echo $_SESSION['id'];?>">
                    <!--Campo Nombre de cuenta-->
                    <div class="form-group">
                      <label>Nombre</label>
                      <input class="form-control" type="text" name="nombre" placeholder="Nombre"></input>
                    </div>
                      <!--Campo de saldo inicial de cuenta-->
                    <div class="form-group">
                      <label>Saldo Inicial</label>
                      <input class="form-control" name="saldo" type="number" id="saldo">
                  </div>
                

                <!--Boton de ingreso-->
                <input class="btn  btn-block" type="submit" id="submit" name="submit" value="Ingresar">
