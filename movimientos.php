          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped " id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                $query='SELECT m.fecha,m.cuenta,m.descripcion,m.monto,m.tipo,c.nombre FROM movimientos m join cuentas c where '.$_SESSION["id"].'=c.idusuario and m.cuenta=c.idcuenta';  
