          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped " id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                //Consulta a BD
                $query='SELECT m.fecha,m.cuenta,m.descripcion,m.monto,m.tipo,c.nombre FROM movimientos m join cuentas c where '.$_SESSION["id"].'=c.idusuario and m.cuenta=c.idcuenta and m.tipo="-1"';  
                $result = mysqli_query($link,$query) or die('Consulta fallida: ' . mysqli_error()); 

                //Recorrido de los elementos
                while ($row=mysqli_fetch_object($result)){
                        //Colocacon en la tabla
