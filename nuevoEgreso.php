    ...
    <div class="container-fluid ">
      <!--*************************-->
        <!-- Example DataTables Card-->
          ...
          <div class="card-header bg-danger" style="color:white">Nuevo Egreso</div>
            <div class="card-body">
              ...
              <form action="assets/nuevoMovimiento.php" method="post">
                ...
                <div class="form-group">
                    <label>Fecha</label>
                    <input class="form-control" type="datetime-local" name="fecha" placeholder="Comentario..."></input>
                </div>
                ...
                <input class="btn btn-danger btn-block" type="submit" id="submit" name="submit" value="Ingresar">
